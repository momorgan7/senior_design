...
User.create(username:"robin",password:"password",password_confirmation:"password",email:"robin@gothamcity.net") 
UserRole.create(user_id: User.second.id,role_id: Role.second.id)  
User.create(username:"bruce",password:"password",password_confirmation:"password",email:"bruce@gothamcity.net") 
